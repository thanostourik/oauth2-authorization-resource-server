...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
	...
	@Value("${oauth2jwt.client.web.client-id}")
	private String clientId;

	@Value("${oauth2jwt.client.web.client-secret}")
	private String clientSecret;

	@Value("${oauth2jwt.authorization-server.access-token-validity}")
	private int accessTokenValiditySeconds;

	@Value("${oauth2jwt.authorization-server.refresh-token-validity}")
